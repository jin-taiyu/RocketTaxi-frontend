...
loop3 = setInterval(() => {
  if (i > 40) {
    ...
    thirdDigit.value = Math.floor(Math.random() * 9) + 1
    i++
  }
}, time)
...
loop2 = setInterval(() => {
  if (i > 80) {
    ...
    secondDigit.value = Math.floor(Math.random() * 9) + 1
    i++
  }
}, time)
...
loop1 = setInterval(() => {
  if (i > 100) {
    ...
    firstDigit.value = Math.floor(Math.random() * 9) + 1
    i++
  }
}, time)
</script>
    ...
    <div class="error">
      <div class="container-floud">
        <div style="text-align: center">
          ...
          <h2 class="h1">页面走丢了QAQ</h2>

          <a-button @click="goHome" size="large" style="width: 150px">返回主页</a-button>
